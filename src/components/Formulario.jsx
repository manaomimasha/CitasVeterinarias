...
const Formulario = () => {
   return (
      <div className='md:w-1/2 lg:w-2/5'>
         ...
         <form action="" className='shadow-md bg-white py-10 px-5 rounded-lg mt-10 mb-10'>
            ...
            <input type="submit"
               className='p-3 w-full text-indigo-600  hover:bg-indigo-700 transition-colors text-white uppercase font-bold cursor-pointer bg-indigo-600 mb-2 mt-5 '
